            ...
            <div className="max-w-3xl mx-auto px-6 py-12">
                ...
                <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
                    <section>
                        ...
                        <p>
                            By accessing or using Cloudisy Console, you agree to
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            rights of others or restrict their use of the
                            service.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            access to the service at our sole discretion,
                            without notice, for conduct that violates these
                            Terms.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            through the support channel in your console
                            settings.
                        </p>
                    </section>
                </div>

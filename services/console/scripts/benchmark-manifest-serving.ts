...
async function main() {
    ...
    console.log(
        "Benchmark (simulated old DB path vs in-memory manifest lookup)",
    );
    ...
    console.log(
        `| p50 ms | ${percentile(oldLatencies, 50).toFixed(4)} | ${percentile(newLatencies, 50).toFixed(4)} |`,
    );
    console.log(
        `| p95 ms | ${percentile(oldLatencies, 95).toFixed(4)} | ${percentile(newLatencies, 95).toFixed(4)} |`,
    );
    console.log(
        `| p99 ms | ${percentile(oldLatencies, 99).toFixed(4)} | ${percentile(newLatencies, 99).toFixed(4)} |`,
    );
    console.log("");
